...
public class RelationshipStateAdapter extends TypeAdapter<RelationshipState> {
    ...
    @Override
    public void write(@NotNull final JsonWriter writer, @Nullable final RelationshipState value) throws IOException {
        if (value == null) {
            writer.nullValue();
    ...
    @Override
    public @Nullable RelationshipState read(@NotNull final JsonReader reader) throws IOException {
        ...
        try {
            return RelationshipState.valueOf(value);
