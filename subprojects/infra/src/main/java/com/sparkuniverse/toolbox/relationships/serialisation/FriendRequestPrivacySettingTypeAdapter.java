...
public class FriendRequestPrivacySettingTypeAdapter extends TypeAdapter<FriendRequestPrivacySetting> {
    ...
    @Override
    public void write(@NotNull final JsonWriter writer, @Nullable final FriendRequestPrivacySetting value) throws IOException {
        if (value == null) {
            writer.nullValue();
    ...
    @Override
    public @Nullable FriendRequestPrivacySetting read(@NotNull final JsonReader reader) throws IOException {
        ...
        try {
            return FriendRequestPrivacySetting.valueOf(value);
