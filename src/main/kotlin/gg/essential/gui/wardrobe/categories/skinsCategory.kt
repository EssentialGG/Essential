...
fun LayoutScope.skinsCategory(wardrobeState: WardrobeState, modifier: Modifier = Modifier) {
    val skins = wardrobeState.visibleSkinItems
    val favorites = skins.filter { it.isFavorite }
    val nonFavorites = skins.filter { !it.isFavorite }
