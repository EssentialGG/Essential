...
/**
 * Just like FIELD but allowed in the constructor.
 * Safe only at injection points after the super call.
 * Fabric supports this by default but upstream Mixin does not.
 */
@InjectionPoint.AtCode("FIELD_IN_INIT")
public class BeforeFieldAccessInInit extends BeforeFieldAccess {
    public BeforeFieldAccessInInit(InjectionPointData data) {
        super(data);
    }
