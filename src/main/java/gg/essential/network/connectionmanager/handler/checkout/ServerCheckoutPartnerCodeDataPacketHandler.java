...
public class ServerCheckoutPartnerCodeDataPacketHandler extends PacketHandler<ServerCheckoutPartnerCodeDataPacket> {
    ...
    @Override
    protected void onHandle(@NotNull final ConnectionManager connectionManager, @NotNull final ServerCheckoutPartnerCodeDataPacket packet) {
        connectionManager.getCoinsManager().onCreatorCodeData(packet.getPartnerCode(), packet.getPartnerName(), packet.isPersist());
    }
