...
public class ServerScreenshotListPacketHandler extends PacketHandler<ServerMediaPopulatePacket> {
    ...
    @Override
    protected void onHandle(@NotNull ConnectionManager connectionManager, @NotNull ServerMediaPopulatePacket packet) {
        screenshotManager.screenshotsReceived(packet.getMedias());
    }
}
