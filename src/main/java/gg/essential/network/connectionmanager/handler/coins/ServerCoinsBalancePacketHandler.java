...
public class ServerCoinsBalancePacketHandler extends PacketHandler<ServerCoinsBalancePacket> {
    ...
    @Override
    protected void onHandle(@NotNull final ConnectionManager connectionManager, @NotNull final ServerCoinsBalancePacket packet) {
        connectionManager.getCoinsManager().onBalanceUpdate(packet.getCoins(), packet.getCoinsSpent(), packet.getTopUpAmount());
    }
