...
object PlayerModel {
    ...
    val steveBedrockModel = BedrockModel(cosmetic, "", steveModelFile, animationFile, emptyMap(), null, null, emptyMap())
    val alexBedrockModel = BedrockModel(cosmetic, "", alexModelFile, animationFile, emptyMap(), null, null, emptyMap())
}
