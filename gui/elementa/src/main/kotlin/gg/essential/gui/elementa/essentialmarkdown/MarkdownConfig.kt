...
data class TextConfig @JvmOverloads constructor(
    ...
    val selectionForegroundColor: Color = color,
    val selectionBackgroundColor: Color = Color(0x507BBA),
)
...
data class URLConfig @JvmOverloads constructor(
    val fontColor: Color = Color(1, 165, 82),
    val fontColorOnHover: Color = Color(1, 165, 82),
    val underline: Boolean = false,
    val underlineOnHover: Boolean = true,
    val enabled: Boolean = true
)
