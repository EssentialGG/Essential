 ...
 */
// Note: This is from loader stage2 (without the lwjgl exclusion), apply fixes there as well
...
public class IsolatedClassLoader extends URLClassLoader {
    ...
    private final List<String> exclusions = new ArrayList<>(Arrays.asList(
    ...
    public void addExclusion(String packagePrefix) {
    ...
    public Enumeration<URL> getResources(String name) throws IOException {
        // Workaround for https://github.com/LWJGL/lwjgl3/issues/737
        // See Library#checkHash
